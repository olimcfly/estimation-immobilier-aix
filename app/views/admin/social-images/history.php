<style>
  ...
  .history-table tr:hover td { background: rgba(30, 58, 95, 0.03); }
  ...
  .template-badge.estimation { background: rgba(30,58,95,0.1); color: #1E3A5F; }
  ...
  .template-badge.story { background: rgba(30,58,95,0.1); color: #1E3A5F; }
  .template-badge.paysage { background: rgba(45,10,24,0.1); color: #0a1a30; }
