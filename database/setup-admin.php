 ...
 *   ADMIN_EMAIL - Admin email (default: contact@estimation-immobilier-aix-en-provence.fr)
 */
...
$email = $argv[1] ?? $_ENV['ADMIN_EMAIL'] ?? 'contact@estimation-immobilier-aix-en-provence.fr';
...
echo "\nSetup terminé !\n";
echo "Connectez-vous sur : https://estimation-immobilier-aix-en-provence.fr/admin/login\n";
