  ...
  var templates = {
    estimation: {
      fields: [
        ...
        { id: 'brand', label: 'Marque', type: 'text', value: 'estimation-immobilier-aix-en-provence.fr' },
    ...
    conseil: {
      fields: [
        ...
        { id: 'url', label: 'URL', type: 'text', value: 'estimation-immobilier-aix-en-provence.fr' },
