...
<style>
  ...
  .admin-input:focus, .admin-select:focus, .admin-textarea:focus { outline: none; border-color: var(--admin-primary); box-shadow: 0 0 0 3px rgba(30, 58, 95, 0.1); }
  ...
  .source-badge { display: inline-flex; align-items: center; gap: 0.4rem; padding: 0.3rem 0.75rem; background: rgba(30,58,95,0.08); color: var(--admin-primary); border-radius: 20px; font-size: 0.8rem; font-weight: 600; }
